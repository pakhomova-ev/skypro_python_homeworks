...
class Mailing:
    ...
    def getInfoAboutMailing(self):
          print(f"Отправление {self.track} из {self.from_address.index},\
 {self.from_address.city}, {self.from_address.street}, \
 {self.from_address.building} - {self.from_address.apartment} в\
 {self.to_address.index}, {self.to_address.city}, {self.to_address.street},\
 {self.to_address.building} - {self.to_address.apartment}. \
